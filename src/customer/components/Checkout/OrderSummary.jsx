...
const OrderSummary = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="lg:grid grid-cols-3 relative justify-between ml-16 mr-20 space-x-5">
        ...
        <div className="sticky top-0 h-[100vh] mt-5 lg:mt-0 ml-20m-16 ">
          <div className="border p-5 bg-white shadow-lg rounded-md ">
            ...
            <Button
              ...
              variant="contained"
              type="submit"
              sx={{ padding: ".8rem 2rem", marginTop: "2rem", width: "100%", fontWeight:"bold"}}
            >
              Payment
            </Button>
          </div>
